...
{
    public class AccountAddingValidator : AbstractValidator<AccountAddingDto>
    {
        public AccountAddingValidator()
        {
            RuleFor(a => a.Email).NotNull().WithMessage("Email can not be null")
            ...
            RuleFor(a => a.Password).NotNull().WithMessage("Email can not be null")
                .NotEmpty().WithMessage("Email can not be empty");
        }
